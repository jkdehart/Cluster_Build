...
if [[ ${enable_beegfs_client} -eq 1 ]];then
     wget -P /etc/yum.repos.d https://www.beegfs.io/release/beegfs_7\_1/dists/beegfs-rhel7.repo
     ...
     wget -P $CHROOT/etc/yum.repos.d https://www.beegfs.io/release/beegfs_7\_1/dists/beegfs-rhel7.repo
